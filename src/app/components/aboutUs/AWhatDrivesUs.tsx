const AWhatDrivesUs = () => {
  ...
  return <div data-aos="fade-up"
    ...
    <div className="ml-[98px] mo:ml-0 md:ml-[50px]">
      ...
      <div className="abcgintoText font-semibold text-[65px] mo:text-xl leading-normal mt-[100px] mo:mt-[10px]">
        <div>
      ...
      <div data-aos="fade-up"
        ...
        <div className="text-2xl mo:text-xs font-normal asText leading-normal w-[40%] mo:w-full flex flex-col gap-10 mo:gap-5">
          <div>
