...
const AHeader = () => {
  return <div>
    <div className={` w-container mo:w-full mo:px-5 md:px-3 m-auto flex pt-5 px-[3.125rem]  md:w-full  `}>
      <div className="flex justify-between w-full items-center">
        ...
        <div className=" text-sm font-medium flex  gap-5">
          ...
          <button
            ...
            className="bg-[#1C73FF] text-white rounded-[1.875rem] text-sm font-medium py-[.625rem] px-5 mo:hidden">
