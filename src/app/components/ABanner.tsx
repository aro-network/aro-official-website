      ...
      <div className="w-container m-auto flex pl-[100px]   mo:pl-0 mo:flex-col md:w-full mo:mb-0  mo:w-full  h-full  ">
        <div className="   flex  w-full h-full gap-20 mo:gap-10  pt-[20vh] mo:pt-20 mo:flex-col  ">
          <div className="  md:w-full  mo:w-full mo:text-center relative mo:top-0 md:top-[-50px] top-[-6.25rem] py-5">
            <div className=" text-[66px] mo:text-[1.75rem] md:text-[45px] text-nowrap  mo:px-0  font-medium md:px-[30px] text-[#000000] md:lead-[71px] mo:leading-none leading-[91px] relative z-[9999] font-Ubuntu">
              <div> The New Edge of AI</div>{" "}
            </div>
            <div className="text-[28px] pt-6 md:pt-0    mo:text-xs md:text-[20px] lg:text-nowrap  mo:py-[.875rem] mo:px-0  leading-[38px] font-semibold md:px-[30px] font-AlbertSans text-[#000000B2] relative z-[9999]">
            ...
            <div className=" pt-[3.125rem] mo:pt-0 flex mo:mt-5   items-center gap-10 mo:gap-[15px] md:px-[30px] mo:flex-col-reverse ">
              <button
                ...
                className="bg-[#4281FF] text-white ml-[6px] w-[229px] mo:w-[150px] items-center text-2xl mo:text-base mo:font-medium font-semibold leading-9  flex justify-center h-[56px] mo:h-[42px]  rounded-[22.5rem] btn font-AlbertSans p-3"
              >
                Join Waitlist
              </button>
            </div>
