const AEarly = () => {
  ...
  return <div
    ...
    className="  aos-init aos-animate   w-container m-auto flex px-[170px] mo:px-5 pt-[6.25rem]  md:px-[40px] md:w-full  mo:w-full  flex-col">
    <div className="w-full  absolute ng:hidden flex justify-end  mt-10 translate-x-[-40px] ">
      <img src="../spots.svg" width={118} height={118} className=" object-contain relative top-[-6.25rem] w-[7.375rem] h-[7.375rem] " />
    </div>
      ...
      <div className="flex gap-[4.875rem]  mo:h-full w-full justify-between">
        <div>
          ...
          <div className="text-[#000000] text-base pt-5">
            ...
            <div>
              •  Become a co-creator of EnReach and get rewarded for your contributions.
            </div>
          </div>
